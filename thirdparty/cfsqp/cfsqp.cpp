...
namespace cfsqpspace {
	...
	cfsqp1(int,int,int,int,int,int,int,int,int,int,int *,int,
		...
		void (*)(int,int,double *,double *, void (*)(int,int,double *,double *,void *),void *));
	static void
	check(int,int,int,int *,int,int,int,int,int,int,int,int *,double, double,struct _parameter *);
	static void
	initpt(int,int,int,int,int,int,int,struct _parameter *,
		struct _constraint *,void (*)(int,int,double *,double *,void *),
		void (*)(int,int,double *,double *, void (*)(int,int,double *,double *,void *),void *));
	static void dir(int,int,int,int,int,int,int,int,int,int,int,int,double *,
		double,double,double *,double *,double,double *,double *,int *,
		int *,int *,int *,int *,int *,struct _parameter *,double *,
		double *,struct _constraint *,struct _objective *,double *,
		double *,double *,double *,double *,double *,double **,double *,
		double *,double *,double *,double **,double **,double *,
		double *,struct _violation *,void (*)(int,int,double *,double *,void *),void (*)(int,int,double *,double *,void *));
	static void step1(int,int,int,int,int,int,int,int,int,int,int,int *,int *,int *,
	...
	static void hessian(int,int,int,int,int,int,int,int,int,int,int,int *,int,
	...
	static void out(int,int,int,int,int,int,int,int,int,int,int,int *,double *,
		struct _constraint *,struct _objective *,double,
		double,double,double,double,int);
	static void	update_omega(int,int,int,int *,int,int,int,int,double,double,
		struct _constraint *,struct _objective *,double *,
		struct _violation *,void (*)(int,int,double *,double *,void *),void (*)(int,int,double *,double *,void *),
		void (*)(int,int,double *,double *,	void (*)(int,int,double *,double *,void *),void *),
		void (*)(int,int,double *,double *,	void (*)(int,int,double *,double *,void *),void *),
		void *,int);
	#else
	...
	#ifdef __STDC__
	static void
	dealloc(int,int,double *,int *,int *,struct _constraint *cs,struct _parameter *);
	#else
	static void dealloc();
	#endif

	#ifdef __STDC__
	void cfsqp(int nparam,int nf,int nfsr,int nineqn,int nineq,int neqn,
		...
		void (*gradob)(int,int,double *,double *, void (*)(int,int,double *,double *,void *),void *),
		void (*gradcn)(int,int,double *,double *, void (*)(int,int,double *,double *,void *),void *),
		void *cd)
	#else
	void cfsqp(nparam,nf,nfsr,nineqn,nineq,neqn,neq,ncsrl,ncsrn,mesh_pts,
