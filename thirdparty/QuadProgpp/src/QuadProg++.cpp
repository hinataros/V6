...
namespace quadprogpp {
  ...
  void print_matrix(char* name, const MatrixXd& A, int n = -1, int m = -1);
  void print_vector(char* name, const VectorXd& v, int n = -1);
  ...
  void print_matrix(char* name, const MatrixXd& A, int n, int m)
  {
    std::ostringstream s;
    std::string t;
    if(n==-1)
  ...
  void print_vector(char* name, const VectorXd& v, int n)
  {
    std::ostringstream s;
    std::string t;
    if(n==-1)
