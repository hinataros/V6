...
#ifndef _QUADPROGPP_HPP_
#define _QUADPROGPP_HPP_

// #include "Array.hh"
#include <eigen3/Eigen/Dense>
#include <iomanip>

#define out(x) std::cout << #x << ":" << std::endl << std::setprecision(6) << std::scientific << x << std::endl
