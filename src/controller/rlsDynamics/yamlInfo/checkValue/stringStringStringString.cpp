...
namespace RLS{
  template<>
  bool RLS::YamlInfo::checkValue(bool &value, const string name1, const string name2, const string name3, const string name4)
  {
    if(localKey[key][name1][name2][name3][name4])
      value = localKey[key][name1][name2][name3][name4].as<bool>();
    else
      return false;
