...
void RLS::Walking::resetMat()
{
  ...
  // amiyata VRP interpolation
  dtD = VectorXd::Zero(ht_config.convergenceNum);
  dtS = VectorXd::Zero(ht_config.convergenceNum);

  rXDS = MatrixXd::Zero(3,ht_config.convergenceNum);
  rXSS = MatrixXd::Zero(3,ht_config.convergenceNum);

  rCDS = MatrixXd::Zero(3,ht_config.convergenceNum);
  rCSS = MatrixXd::Zero(3,ht_config.convergenceNum);
