...
VectorXd RLS::ConstraintModel::getControlNodeVector(const VectorXd a, const string type, const string node)
{
  if(debug) DEBUG;
...
VectorXd RLS::ConstraintModel::getControlNodeVector(const VectorXd a, const string type, const int argNum, ...)
{
  if(debug) DEBUG;
...
MatrixXd RLS::ConstraintModel::getControlNodeMatrix(const MatrixXd A, const bool row, const bool col, const string type, const string node)
{
  if(debug) DEBUG;
  ...
  if(row&&col)
    ...
    cout << manip_error("ConstraintModel::getControlNode(): error:")
         << manip_error("Please select 'true'");

  return returnMatrix;
}

MatrixXd RLS::ConstraintModel::getControlNodeMatrix(const MatrixXd A, const bool row, const bool col, const string type, const int argNum, ...)
{
  if(debug) DEBUG;
