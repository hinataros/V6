...
void RLS::Ext::SAM_FrictionDistribution_zRNS(RlsDynamics *io)
{
  if(debug) DEBUG;
  ...
  io->dlCRef(2) = (io->model->IC*io->fb.dwBfb + io->model->dIC*io->model->wB - io->KDlC*io->model->HC*io->model->dth)(2);
