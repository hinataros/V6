...
namespace RLS{
  ...
  private:
    ...
    map<string, VectorXd (RLS::RlsDynamics::*)()> map_motionController;

    void (RLS::RlsDynamics::*operationalSpaceController_ptr)()=0;
    map<string, void (RLS::RlsDynamics::*)()> map_operationalSpaceController;

    void (RLS::RlsDynamics::*momentumController_ptr)()=0;
    map<string, void (RLS::RlsDynamics::*)()> map_momentumController;

    void (RLS::RlsDynamics::*internalForceController_ptr)()=0;
    map<string, void (RLS::RlsDynamics::*)()> map_internalForceController;
    void (RLS::RlsDynamics::*forceController_ptr)()=0;
    map<string, void (RLS::RlsDynamics::*)()> map_forceController;

    void (RLS::RlsDynamics::*torqueController_ptr)()=0;
    map<string, void (RLS::RlsDynamics::*)()> map_torqueController;

    VectorXd (RLS::RlsDynamics::*inverseDynamicsController_ptr)()=0;
    map<string, VectorXd (RLS::RlsDynamics::*)()> map_inverseDynamicsController;

    void (RLS::RlsDynamics::*externalWrenchController_ptr)()=0;
    map<string, void (RLS::RlsDynamics::*)()> map_externalWrenchController;
    // ******************************
